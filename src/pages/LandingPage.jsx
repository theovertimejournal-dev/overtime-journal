...
Every pick is logged to Supabase before tip-off. Every outcome is graded automatically overnight. The record you see on this site is real, dated, and auditable — not cherry-picked from a highlight reel. That's the whole point.`,
  ...
  
  {
    category: 'ANALYSIS',
    date: 'Mar 11',
    title: '$8 → $3,307: Inside the Parlay That Hit Last Night',
    excerpt: 'LAL ML, PHI ML, ATL -9.5, MIA -10.5, DET -9. Five legs. All hit. Here\'s why the model liked every single one.',
    content: `Last night OTJ's parlay builder assembled a 5-legger that paid out $3,307 on an $8 ticket. That's a 413x return. Here's the breakdown of every leg and why the model picked it.

LAKERS ML (+120)

LeBron at home against a rebuilding team. The model had LAL with a +7.2 net rating advantage and a BENCH_EDGE signal firing. Line value on the ML at +120 triggered the ML preference over the spread. This was the anchor leg.
...
None of these legs were picks because "this team is good." Every leg had a specific, named signal firing. The parlay builder also ran gut-check vetoes on all 5 — none had a LINE_VALUE mismatch, so none were blocked.
...
This is what the model is built for.`,
  },
  {
    category: 'EDGE',
    date: 'Mar 9',
