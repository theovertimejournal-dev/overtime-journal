        ...
        if gap >= 2.0 and is_significant:
            ...
            if spread_val < 0 and model_implied > 0:
                ...
                verdict = (
                    ...
                    f"That's a {gap:.0f}-point gap — {home['team']} may be overpriced. "
                    f"{away['team']} could be the value play."
                )
                ...
                verdict = (
                    ...
                    f"That's a {gap:.0f}-point gap — {home['team']} is being underestimated. "
                    f"Could be a value spot."
                )
            elif has_b2b:
