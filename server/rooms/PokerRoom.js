...
class PokerRoom extends Room {
    ...
    handleSitDown(client, { seatIndex, buyIn }) {
        ...
        this.seats[seatIndex] = {
            ...
            currentBet: 0,
            totalBetThisHand: 0,
            status: "sitting_out", // will be "active" next hand
            lastAction: null,
            isDealer: false,
        };
        ...
        console.log(`  🪑 ${client.userData.username} sat at seat ${seatIndex} (${buyIn} chips)`);
        ...
        // If we now have 2+ seated players and game is waiting, start
    ...
    playerStandUp(seat, client = null) {
        ...
        // Return chips to bucks balance (would call Supabase here)
        // TODO: supabase.rpc('add_bucks', { user_id: player.userId, amount: chips })
    ...
    executeAction(seat, action, amount = 0) {
        ...
        if (this.isBettingRoundComplete()) {
            ...
            this.currentTurn = this.nextActiveSeatForBetting(seat);
            this.broadcastState();
            this.startTurnTimer();
        }
    }
    ...
    advancePhase() {
        ...
        this.currentTurn = this.nextActiveSeatForBetting(this.dealerSeat);
        this.broadcastState();
        this.startTurnTimer();
    }
    ...
    showdown() {
        ...
        // Log hand (would save to Supabase)
    ...
    handleAddChips(client, { amount }) {
        ...
        // TODO: Deduct from Supabase bucks_balance
        player.chips += amount;
