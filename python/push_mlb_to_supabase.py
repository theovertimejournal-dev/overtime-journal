...
try:
    ...
    for event in sgo_events:
        ...
        away = (away_team.get("names", {}).get("abbreviation") or
                away_team.get("name", {}).get("abbreviation") or "").upper()
        home = (home_team.get("names", {}).get("abbreviation") or
                home_team.get("name", {}).get("abbreviation") or "").upper()
