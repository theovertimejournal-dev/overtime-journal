...
function CommunityCarousel() {
  ...
  return (
    <div style={{
      maxWidth: 480, margin: '0 auto', padding: '32px 16px',
      fontFamily: "'JetBrains Mono','SF Mono',monospace",
    }}>
      <div style={{ textAlign: 'center', marginBottom: 16 }}>
        <span style={{ fontSize: 9, letterSpacing: '0.18em', color: '#ef4444', fontWeight: 700 }}>🏆 COMMUNITY WINS</span>
        <div style={{ fontSize: 11, color: '#4a5568', marginTop: 4 }}>Real tickets. Real people. Real edge.</div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ padding: '12px 16px 16px' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#f1f5f9', marginBottom: 4 }}>{t.caption}</div>
    ...
    <div style={{ minHeight: '100vh', background: '#08080f', color: '#e2e8f0', fontFamily: MONO }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 10, color: '#9ca3af' }}>
          Pregame breakdowns · live betting · ticket sharing —
        </span>
        <a
          href="https://discord.gg/j3nV3CBY"
          target="_blank"
