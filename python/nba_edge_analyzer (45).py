    ...
    try:
        ...
        if calculate_edge._ml_clf is not None:
            ...
            if ml_confidence >= 0.10:  # Only fire when model has real conviction
                ...
                # v1: DISPLAY ONLY — shows on game card but does NOT affect edge score
                # Once validated over 1-2 weeks, uncomment the score line below
